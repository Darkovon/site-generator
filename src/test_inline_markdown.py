...
class TestInlineMarkdown(unittest.TestCase):
    ...
    def test_split_images_start_end(self):
        node = TextNode(
        "![image](https://i.imgur.com/zjjcJKZ.png) an image at the start and the end ![image](https://i.imgur.com/zjjcJKZ.png)",
        TextType.TEXT,
        )
        new_nodes = split_nodes_image([node])
        self.assertListEqual(
            [
                TextNode("image", TextType.IMAGE, "https://i.imgur.com/zjjcJKZ.png"),
                TextNode(" an image at the start and the end ", TextType.TEXT),
                TextNode("image", TextType.IMAGE, "https://i.imgur.com/zjjcJKZ.png"),
            ],
            new_nodes,
        )

    def test_split_image_broken(self):
    ...
    def test_split_link_start_end(self):
        node = TextNode(
            "[link](https://i.imgur.com/zjjcJKZ.png) a link at the start and the end [link](https://i.imgur.com/zjjcJKZ.png)",
            TextType.TEXT,
        )
        new_nodes = split_nodes_link([node])
        self.assertListEqual(
            [
                TextNode("link", TextType.LINK, "https://i.imgur.com/zjjcJKZ.png"),
                TextNode(" a link at the start and the end ", TextType.TEXT),
                TextNode("link", TextType.LINK, "https://i.imgur.com/zjjcJKZ.png"),
            ],
            new_nodes,
        )

    def test_split_link_broken(self):
